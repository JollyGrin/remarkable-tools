...
<main class="container">
  <div class="hero">
    ...
    <p class="tagline">Transform any Substack blog into an EPUB file for easy reading on your e-reader</p>
  </div>
  
  <div class="card">
    <div class="card-body">
      <h2>Convert a Substack Blog</h2>
      <p>Enter the username of any Substack blog to generate an EPUB file with the latest articles.</p>
  ...
  <footer>
    <p>Built with ♥ by <a href="https://github.com/JollyGrin/remarkable-tools" target="_blank">JollyGrin</a></p>
  </footer>
</main>
